...
topics.push(aardvark)
const abandonment = new Topic({
    name: "Hiking",
    category: "Outdoor Activities",
...
topics.push(abandonment)
const abatement = new Topic({
    name: "Kayaking",
    category: "Outdoor Activities",
...
topics.push(abatement)
const abbreviation = new Topic({
    name: "Rock Climbing",
    category: "Outdoor Activities",
...
topics.push(abbreviation)
const abeam = new Topic({
...
topics.push(abeyance)
const abidingly = new Topic({
...
topics.push(abidingly)
const abjure = new Topic({
    name: "Sailing",
    category: "Outdoor Activities",
...
topics.push(ablution)
const aboard = new Topic({
    name: "Skateboarding",
    category: "Outdoor Activities",
...
topics.push(abominate)
const abortively = new Topic({
...
topics.push(abortively)
const abrasive = new Topic({
    name: "Picnic areas",
    category: "Outdoor Activities",
...
topics.push(abrasive)
const abrogate = new Topic({
    name: "Viewpoints",
    category: "Outdoor Activities",
...
topics.push(abrogate)
const abscessed = new Topic({
    name: "Archery",
...
topics.push(abscessed)
const absentee = new Topic({
    name: "Billiards",
    category: "Sports and Hobbies",
...
topics.push(absentee)
const absolute = new Topic({
    name: "Bowling",
    category: "Sports and Hobbies",
...
topics.push(absorbed)
const abstainer = new Topic({
    name: "Cycling",
    category: "Sports and Hobbies",
...
topics.push(abstainer)
const abstracted = new Topic({
    name: "Golfing",
    category: "Sports and Hobbies",
...
topics.push(abstracted)
const abstruseness = new Topic({
    name: "Pottery",
    category: "Sports and Hobbies",
...
topics.push(abstruseness)
const abuser = new Topic({
    name: "Swimming",
    category: "Sports and Hobbies",
...
topics.push(abysmally)
const academician = new Topic({
    name: "Yoga",
    category: "Sports and Hobbies",
...
topics.push(academician)
const accent = new Topic({
    name: "Meditation",
    category: "Sports and Hobbies",
...
topics.push(accent)
const acceptableness = new Topic({
    name: "Mini Golf",
    category: "Sports and Hobbies",
...
topics.push(acceptableness)
const accessibly = new Topic({
    name: "Dancing",
    category: "Art",
...
topics.push(accessibly)
const acclamation = new Topic({
    name: "Painting",
    category: "Art",
...
topics.push(acclamation)
const accommodating = new Topic({
    name: "Photography",
    category: "Art",
...
topics.push(accommodating)
const accomplish = new Topic({
    name: "Music",
    category: "Art",
...
topics.push(accomplish)
const accordingly = new Topic({
    name: "Burgers",
...
topics.push(accordingly)
const accountant = new Topic({
    name: "French Food",
    category: "Food and Cooking",
...
topics.push(accountant)
const accreditation = new Topic({
    name: "Japanese Food",
    category: "Food and Cooking",
...
topics.push(accreditation)
const accumulation = new Topic({
    name: "Chinese Food",
    category: "Food and Cooking",
...
topics.push(accumulation)
const accursedness = new Topic({
    name: "Mexican Food",
    category: "Food and Cooking",
...
topics.push(accursedness)
const accustom = new Topic({
    name: "Italian Food",
    category: "Food and Cooking",
...
topics.push(accustom)
const acetate = new Topic({
    name: "Thai Food",
    category: "Food and Cooking",
...
topics.push(acidify)
const acknowledgment = new Topic({
    name: "Board Games",
    category: "Games",
...
topics.push(acknowledgment)
const acoustically = new Topic({
    name: "Trivia Nights",
    category: "Games",
...
topics.push(acoustically)
const acquiescent = new Topic({
    name: "Video Games",
    category: "Games",
